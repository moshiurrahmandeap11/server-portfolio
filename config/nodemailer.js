...
export const sendAutoReplyEmail = async (to, name) => {
    try {
        const mailOptions = {
                    ...
                    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                        ...
                        <div style="background: #111827; padding: 30px; border-radius: 0 0 20px 20px; border: 1px solid #1f2937; border-top: none;">
                            ...
                            <div style="text-align: center; margin-bottom: 20px;">
                                ...
                                <a href="https://moshiur.online" style="display: inline-block; background: #f97316; color: white; text-decoration: none; padding: 12px 24px; border-radius: 10px; font-weight: 600; font-size: 14px; margin: 0 5px;"> Website</a>
            ...
            html: `
                ...
                <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0a0f1e;">
                    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                        ...
                        <!-- Header -->
                        <div style="background: linear-gradient(135deg, #020b1a, #0d0818); padding: 30px; border-radius: 20px 20px 0 0; text-align: center;">
...
<div style="background: #1a1f2e; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
    ...
    <div style="color: #ffffff !important; font-size: 15px; line-height: 1.7; white-space: pre-wrap; word-break: break-word; background: transparent;">
    ${contactData.message}
    </div>
</div>
